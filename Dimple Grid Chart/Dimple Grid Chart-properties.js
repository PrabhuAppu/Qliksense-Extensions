 ...
 */
 ...
 var buttonsGrid = '<div class="QvExtensioncontainer row container-fluid main"><div class="col-md-12">'+
						'<div class="row" style="padding:20px;">'+
							...
							'<div class="btn-group" role="group">'+
								'<button type="button" class="btn btn-default play active"><img style="width: 15px;height: 15px;padding: 0px;" src="../extensions/Dimple Grid Chart/images/play.PNG"></img></button>'+
								'<button type="button" class="btn btn-default pause"><img style="width: 15px;height: 15px;padding: 0px;" src="../extensions/Dimple Grid Chart/images/pause.PNG"></img></button>'+
