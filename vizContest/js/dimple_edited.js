                                ...
                                .each(function () {
                                    var rec = this.getBBox();
                                       var txt = d3.select(this)
                                        //.attr("transform", "rotate(0," + rec.x + "," + ((rec.y + (rec.height / 2))+0) + ") translate(-5, 0)")
										.attr("transform", "rotate(0)")//"," + rec.x + "," + ((rec.y + (rec.height / 2))+0) + ") translate(0, 0)")
										.text("");
										txt.append("tspan")
										  .text(function(d) { 
										  var tee = d;
