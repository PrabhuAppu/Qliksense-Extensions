define(["jquery", "./VizContest-FastChange-properties", "text!./css/bootstrap.css", "text!./FastChange.css", "./d3.v3.min", "./FastChangeChart","./js/bootstrap.min"], 
function($, properties, bootstrap,cssContent, d3) {
	...
	return {
		...
		paint : function($element, layout) {
			...
			var fastchange = data;
			DrawFastChange(fastchange,layout.props.colorTheme);
