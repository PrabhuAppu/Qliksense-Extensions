function DrawFastChange(csv, colorNumber){
...
//alert(JSON.stringify(symbol));
  ...
  symbols.sort(function(a, b) { return b.price - a.price; });
...
//alert(y);
  ...
  g.each(function(d) {
    ...
    var text1 =  e.append("text")
		...
		//+(d.key.split(' ').length>2?" "+d.key.split(' ')[2]:"")
  });
...
function showtooltip(d){
		...
		if($('.chartname').html()==="Transposed Bar"){
			...
			var html =	(d.symbol=='WFH'?'Work From Home':d.symbol )+ " : " + d.price;
		}
