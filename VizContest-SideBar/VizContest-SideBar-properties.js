 ...
 */
 ...
 var buttonsGrid = '<div class="row container-fluid main"><div class="col-md-12">'+
						'<div class="row" style="padding:20px;">'+
							...
							'<div class="btn-group" role="group">'+
								'<button type="button" class="btn btn-default play active"><span class="glyphicon glyphicon-play" aria-hidden="true"></span></button>'+
								'<button type="button" class="btn btn-default pause"><span class="glyphicon glyphicon-pause" aria-hidden="true"></span></button>'+
